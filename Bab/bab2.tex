...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption[Contoh masalah linear programming tanpa daerah \textit{feasible}]{Contoh masalah linear programming tanpa daerah \textit{feasible}}
